  ...
  return (
    <>
      <div className="grid grid-cols-2 border-b pb-4 border-gray-500">
        <div className="grid grid-cols-2 grid-rows-2 p-10 order-2 col-span-2 md:order-1 md:col-span-1 md:p-36 gap-x-40">
        ...
        <iframe
          className="w-screen md:w-full md:h-full order-1 col-span-2 md:col-span-1 md:order-2"
          loading="lazy"
          src="https://www.google.com/maps/embed/v1/place?key=AIzaSyCpef-gkrTgpAJDV_ds5wM_VPa1D6vYlOw
      &q=Space+Needle,Seattle+WA"
        ></iframe>
      </div>
      <p className="text-center mt-5 mb-5 text-sm md:text-base">
        کپی رایت ۱۴۰۰ کلینیک زیبایی آفرینش. تمامی حقوق برای ما محفوظ است. | قدرت
        گرفته توسط هایک
      </p>
    </>
  );
